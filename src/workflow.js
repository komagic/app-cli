...
module.exports = class extends baseGenerator {
	...
	async main(){
		await confirm(this.answers.outputFolderName)
		await this.downloadTemplate(this.templates[this.answers['appType']],tempDir)
	...
	copyEjs (answers) {
		...
		return src(this.templatePath(tempDir)+'/**', { nodir: true })
			...
			.pipe(dest(this.answers.outputFolderName)).on('end',()=>{
